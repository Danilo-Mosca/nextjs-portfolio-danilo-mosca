...
export default function Slide({ title, description, icon }: SlideProps) {
    return (
        <div className="flex flex-col border-2 border-accent-blue rounded-2xl min-w-[300px] overflow-hidden hover:border-accent-green transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-accent-green/10">
